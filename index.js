require('dotenv').config() // using .env module
...
app.get('/api/offices', function(req, res) { // creating endpoint DBtest - selecting 
...
app.get('/api/employees/:id', function(req, res) { // select specific employee
